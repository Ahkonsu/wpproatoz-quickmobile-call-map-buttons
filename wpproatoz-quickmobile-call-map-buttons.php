...
$myUpdateChecker = PucFactory::buildUpdateChecker(
    'https://github.com/Ahkonsu/wpproatoz-quickmobile-call-map-buttons/',
    __FILE__,
    'wpproatoz-quickmobile-call-map-buttons'
);
...
// Huston ..we have lift off. Seems it was a bit limp so we added some galexy chargers here..
